...
var handleMode = function(event) {
  ...
  var mapping = device.mappings.ModeController.instance[instance];
  Object.assign(mapping, (({characteristic_type}) => ({characteristic_type})) (device.mappings.ModeController));

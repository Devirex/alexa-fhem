...
function deviceToEndpoints(device) {
  ...
  if( device.mappings.ModeController ) {
    for (var keys of Object.keys(device.mappings.ModeController)) {
      log.debug(keys + " -> " + device.mappings.ModeController[keys])
      var instance = device.mappings.ModeController[keys];
      var assets = []; 
